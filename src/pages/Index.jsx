...
const Index = () => {
  return (
    <div className="relative min-h-screen w-full overflow-hidden bg-gradient-to-br from-[#d5d9c8] to-[#97a09f]">
      ...
      />
      <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-br from-[#d5d9c8]/80 to-[#97a09f]/80" />
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen px-4 py-12">
        <div className="flex flex-col lg:flex-row gap-8 w-full max-w-7xl">
          <div className="text-center p-8 bg-[#d5d9c8]/10 backdrop-blur-md rounded-lg shadow-xl w-full lg:w-1/2 mb-8 lg:mb-0 animate-float">
          ...
          <div className="bg-[#97a09f]/10 backdrop-blur-md rounded-lg shadow-xl w-full lg:w-1/2 p-8 text-[#d5d9c8]">
      ...
      <div className="absolute bottom-4 right-4 flex space-x-4">
        <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" className="text-[#97a09f]/70 hover:text-[#97a09f] transition-colors duration-300">
          <Facebook size={24} />
        </a>
        <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="text-[#97a09f]/70 hover:text-[#97a09f] transition-colors duration-300">
          <Instagram size={24} />
        </a>
        <a href="mailto:hej@overlandsoul.se" className="text-[#97a09f]/70 hover:text-[#97a09f] transition-colors duration-300">
          <Mail size={24} />
        </a>
      </div>
    </div>
